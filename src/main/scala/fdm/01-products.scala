...
/**
  * Scala 3 supports tuples, which are a generic way to store two or more pieces of information at 
  ...
  * 
  * Scala 3 supports tuples of any "arity": that is, tuples can have as many elements as necessary.
  * 
...
/**
  * Scala 3's case classes come equipped with useful functionality that all "data classes" should 
...
/**
  * Scala 3's case classes can be generic, which means the types defined by case classes may have 
